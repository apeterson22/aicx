...
Shelf Label QR Codes – Use AegisQR retail profiles to sign a compact payload containing SKU, UPC, store, aisle, bay, label version, campaign ID, deep-link URI, and fallback URL. This enables any standard QR scanner to decode the payload and open the correct page in the AegisQR app or website.
